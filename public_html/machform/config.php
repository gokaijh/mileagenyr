...
define('MF_DB_NAME', 'mileages_mileage'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'mileages_mileage'); //Your database username
define('MF_DB_PASSWORD', 'New36161113'); //Your database users password
